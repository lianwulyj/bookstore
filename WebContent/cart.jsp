...
<script type="text/javascript">
    function changeNum(id,num,totalCount){
    	...
    	window.location.href="${pageContext.request.contextPath}/changeNumServlet?id="+id+"&num="+num;
                                            ...
                                            <c:forEach var="entry" items="${map}" varStatus="vs">
                                              <table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="20%">
														<input type="button" value='-'
															style="width:20px" onclick="changeNum('${entry.key.id}','${entry.value-1}','${entry.key.pnum}')">

															<input name="text" type="text"  value="${entry.value}"
															style="width:40px;text-align:center" /> <input
															type="button" onclick="changeNum('${entry.key.id}','${entry.value+1}','${entry.key.pnum}')" value='+' style="width:20px">
