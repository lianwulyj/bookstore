						...
						<tr>
							<td>
								...
								<table cellspacing="0" class="booklist">
									<tr>
									   <c:forEach var="b" items="${pb.products}">
									       <div class="divbookpic">
												<p>
													<a href="#"><img src="${pageContext.request.contextPath}/upload/${b.img_url}" width="115"
														height="129" border="0" /> </a>
												</p>
												
												<div class="divlisttitle">
												<a href="${pageContext.request.contextPath}/findBookInfoServlet?id=${b.id}">${b.name}<br />售价:${b.price}</a>
											</div></td>
											</div>
