...
<div id="divmenu">
	<a
		href="${pageContext.request.contextPath}/pageServlet?category=A">文学</a>
	<a
		href="${pageContext.request.contextPath}/pageServlet?category=B">生活</a>
	<a
		href="${pageContext.request.contextPath}/pageServlet?category=C">计算机</a>
	<a
